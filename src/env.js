import { componentToken } from "./lib/component_lib";
/**
...
export const htmlComponent = new componentToken("html");

export const bodyComponent = new componentToken("body");

export const rootComponent = new componentToken("#root");

export const boardComponent = new componentToken(".board");